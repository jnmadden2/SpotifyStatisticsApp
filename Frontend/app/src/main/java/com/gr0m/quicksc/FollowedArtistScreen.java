...
public class FollowedArtistScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonNavigation_TopArtists.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(FollowedArtistScreen.this, TopArtistScreen.class);
        ...
        ButtonNavigation_TopTracks.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(FollowedArtistScreen.this, TopTrackScreen.class);
                startActivity(intent);
        ...
        ButtonNavigation_RecentlyPlayed.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(FollowedArtistScreen.this, RecentlyPlayedScreen.class);
                startActivity(intent);
        ...
        ButtonNavigation_ChatScreen.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(FollowedArtistScreen.this, ChatScreen.class);
                startActivity(intent);
        ...
        ButtonNavigation_MainScreen.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(FollowedArtistScreen.this, MainScreen.class);
                startActivity(intent);
